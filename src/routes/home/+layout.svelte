<script>
	...
	import UserAppBar from '$lib/components/content/UserAppBar.svelte';
	import FlatAlert from '$lib/components/content/FlatAlert.svelte';
	import UserAppRail from '$lib/components/content/UserAppRail.svelte';
	import UserBottomNav from '$lib/components/content/UserBottomNav.svelte';
</script>
